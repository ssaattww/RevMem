...
CI is used only for verification/diagnostics and was not used to update code. Final exact-head result is reported in the PR conversation after this report is published.
