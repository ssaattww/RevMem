...
IFR001/005 closedを維持し、IFR002〜004だけをR5としてaddressedした。technical implementation SHAはcommit前のためpendingである。
...
IFR002〜004 addressed、IFR001/005 closed維持。same reviewer closure R5 pending、PR body external sync pending、CI heldである。

## リスク

technical SHA pending、same reviewer closure R5、exact-head CI、PR body external syncは未実施。Markdown wording toolingはunsupported/heldである。
