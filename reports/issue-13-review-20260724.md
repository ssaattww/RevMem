...
- 文書・進捗同期確認head: `c16ef9ee9c355b490d751577f6f80406aab8859f`
...
文書・進捗同期確認head `c16ef9ee9c355b490d751577f6f80406aab8859f`に紐づくrun `30094394959`でも、同じ全工程が成功した。

同repositoryの別branchまたは他作業者の最新runではなく、各head SHAに紐づくrunだけを最終判定に使用した。レポート自身を更新した最終PR headのCI結果はPR本文へ記録する。
