...
| P3 | 進行中 | diff editorとPR進捗 | T300〜T306 | P2 | T300〜T305はmainへ統合済み。T306は通常reviewの実UI/runtime・bounded termination findingsを修正中 |
...
- T306 diff操作から進捗UIまでのExtension Host試験: 通常review指摘対応中
