...
| P1 | 進行中 | ローカル行範囲管理 | T101〜T107 | P0 | 通常エディタで確認・解除・装飾・再起動復元が動き、AC-01〜AC-06とAC-23のローカル部分を満たす |
| P2 | 進行中（T201先行完了） | 編集・Git差分追従 | T201〜T207 | P1 | 編集、commit、branch、renameに追従し、変更箇所だけが未確認になる。AC-07〜AC-10とAC-12を満たす |
