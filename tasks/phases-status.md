...
| P6 | 進行中 | Gitなし対応と堅牢化 | T601〜T610 | P1〜P5 | T601〜T609はmainへ統合済み。T609はPR #82のsquash merge `477725632177f5c4fcbca5eb587644fdef06e4df`で完了。T610 / Issue #78を設計中、T608は未着手 |
...
- 実装中タスク: T610 / Issue #78 folder単位Global Understanding（PR #83、設計更新中）
- 次の工程: T610設計commit、local TDD実装、通常・独立review、exact-head CI、PR #83 squash merge
- 後続候補: T608
...
- T610: Issue #78のfolder単位Global UnderstandingをPR #83で設計中。file open direct-only、explicit subtree、persisted stopped marker、partial parent、descendant自動開始設定を実装する。
