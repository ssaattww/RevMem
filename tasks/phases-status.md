...
| P5 | 進行中 | Global確認済みと理解率 | T501〜T506 | P2、P4 | T501のGlobal同期とlossless履歴証跡は独立review全4 findingをclosed、exact-head CI成功済み。T504はPR #39で独立reviewの3 findingを修正・検証中であり、closureと再reviewは未了。表示優先順位、非空行集計、除外設定を進める |
