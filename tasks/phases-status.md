...
- 実装中タスク: T610 / Issue #78 folder単位Global Understanding（PR #83、通常review前）
- 次の工程: T610通常review、finding closure、full local equivalence、独立review、exact-head CI、PR #83 squash merge
- 後続候補: T608
...
- T610: Issue #78のfolder単位Global UnderstandingをPR #83でlocal実装済み。file open direct-only、explicit subtree、persisted stopped marker、partial parent、descendant自動開始設定、scope-local cancellation、Tree actionを通常reviewへ渡す。
