...
- 次の工程: T610 Host scope-root identity R5、同reviewer finding closure、full local equivalence、独立review、exact-head CI、PR #83 squash merge
- 後続候補: T608
...
- T610: Host R4でContext/open lifecycleは正常、source refreshがcontroller前のowner/scope-root解決で`undefined`となる境界へ限定。R5でWindows workspace URI identityを修正する。
