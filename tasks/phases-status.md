...
| P3 | 進行中 | diff editorとPR進捗 | T300〜T306 | P2 | T300〜T305はmainへ統合済み。T306のfocused Extension Host試験はGreen、reviewとmergeを残す |
...
- T306 diff操作から進捗UIまでのExtension Host試験: focused Green・通常review待ち
