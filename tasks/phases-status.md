...
| P6 | 進行中 | Gitなし対応と堅牢化 | T601〜T608 | P1〜P5 | T601〜T605はmainへ統合済み。T606はR001〜R005 R6 addressed・same normal reviewer closure待ち、T607〜T608は未着手 |

## 現在位置

- T306 merge commit: `ec74b88c68df73acf84373eeaf2706fae2d1b6f0`
- 直近統合: T603 schema migration・破損隔離・回復（PR #53、merge commit `8cbdaa55`）
- 実装中タスク: T606 / Issue #76 unified failure policy, retry, stale UI, and privacy-safe diagnostics（R001〜R005のR6 technical commit `d7649b6d10fcb3a1c30d79ec78a1161ff1ef7c52`・focused 195 passing、same normal reviewer closure待ち。R006はclosed）
...
- T606: R006はclosedを維持。R001〜R005はR6 technical commit `d7649b6d10fcb3a1c30d79ec78a1161ff1ef7c52`・focused 195 passing/2 skipでaddressed、同一normal reviewerのfinding限定closure R6待ち（Issue #76、PR #77、exact-head CI held）
- T607〜T608: 未着手
